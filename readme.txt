...
== Description ==
Kindle-This is a sidebar widget that displays a button for sending a blog page to a user's Kindle using free.kindle.com automatic conversion. It also includes a shortcode to send individual posts or pages to a Kindle.
...
The plugin uses only the free.kindle.com service so the document will appear on the Kindle device as soon as the user makes a wifi connection.
